              ...
              (<>
                <form className="border border-dark" autoComplete="off" id="login">        
                  <div className="d-flex flex-column align-items-center" >
                    ...
                    <div className="col-12 d-flex justify-content-end mb-2 me-4">
                        <a className="mt-2 me-1 fw-bold text-decoration-none" href="/customer/login">Go back to Login Page ?</a>
                    </div>
                    <div className="col-12 mt-2" id="loginitem">
                      <button className="btn btn-primary mb-4" id="loginbtn" type="submit">Submit</button>
                    </div> 
                    <div className="col-12 d-flex justify-content-end mb-2 me-4">
                      <a className="fw-bold" href="/customer/register">Don't have an account.Click here to Sign in</a>
                    </div>                    
                  </div>
                </form>
               </>)
