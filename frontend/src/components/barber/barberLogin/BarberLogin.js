...

          {
            !formData.forgotPassword ? 
              (<>
                  <form className="border border-dark" autoComplete="off" id="login">        
                    <div className="d-flex flex-column align-items-center" >
                        ...
                        <center>
                            <h2 className="fw-bold mt-2" id="logintitle">Barber Login</h2> 
                        </center>
                        ...
                        <div className="col-12 mt-2" id="loginitem">
                            <button className="btn btn-primary mb-4" id="loginbtn" type="submit">Log In</button>
                        </div> 
                        <div className="col-12 d-flex justify-content-end mb-2 me-4">
                            <a className="fw-bold" href="/barber/register">Don't have an account.Click here to Register</a>
                        </div> 
                        <div className="col-12 d-flex justify-content-end mb-2">
                            <a className="me-3 fw-bold" href="/customer/login">customer Login ?</a>
                        </div>       
                    </div>
                  </form>
              </>) :
              ...
              (<>
                <form className="border border-dark" autoComplete="off" id="login">        
                  <div className="d-flex flex-column align-items-center" >
                    <h2 className="fw-bold mt-3" id="resetpasstitle">Verify to Reset Password</h2> 
                    <div className="col-12 mt-5" id="loginitem">
                          ...
                          <> 
                          {
                              ...
                              (
                                  ...
                                  <div className="row mt-3" id="loginitem">
                                      ...
                                      <button className="col-3 me-0 ms-auto bg-success" >submit OTP</button>
                                  </div>
                                  </>
                              ) :
                              (
                                  <>
                                    <div className="row mt-3" id="loginitem">                      
                                      <button className="col-4 me-0 ms-auto" >Verify email</button>
                                    </div>
                                  </>
                              )
                          }                
                    ...
                    <div className="col-12 d-flex justify-content-end mb-2 me-4">
                        <a className="mt-2 me-1 fw-bold text-decoration-none" href="/barber/login">Go back to Login Page ?</a>
                    </div>
                    <div className="col-12 mt-2" id="loginitem">
                      <button className="btn btn-primary mb-4" id="loginbtn" type="submit">Submit</button>
                    </div> 
                    <div className="col-12 d-flex justify-content-end mb-2 me-4">
                      <a className="fw-bold" href="/barber/register">Don't have an account.Click here to Sign in</a>
                    </div>                    
                  </div>
                </form>
               </>)
